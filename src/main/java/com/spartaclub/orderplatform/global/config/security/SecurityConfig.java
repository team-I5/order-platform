...
/**
 * Spring Security 설정 클래스 JWT 기반 인증 및 권한 관리 설정 실시간 권한 체크를 통한 보안 강화 구현
 *
 * @author 전우선
 * @date 2025-10-09(목)
 */
...
public class SecurityConfig {
    ...
    /**
     * HTTP 보안 설정을 정의하는 SecurityFilterChain 빈 생성 JWT 기반 인증, 권한별 접근 제어, 실시간 권한 체크 설정
     *
    ...
    /**
     * JWT 인증 필터 빈 생성 실시간 권한 체크를 위한 커스텀 JWT 필터
     *
    ...
    /**
     * BCryptPasswordEncoder 빈 생성 비밀번호 암호화를 위한 BCrypt 해시 알고리즘 인코더 제공
     *
