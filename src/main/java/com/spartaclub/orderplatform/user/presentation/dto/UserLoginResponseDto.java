...
/**
 * 로그인 응답 DTO 로그인 성공 시 클라이언트에게 반환되는 데이터 전송 객체 JWT 토큰 정보와 사용자 기본 정보 포함
 *
 * @author 전우선
 * @date 2025-10-02(목)
 */
...
public class UserLoginResponseDto {
    ...
    /**
     * 로그인 성공 응답 DTO 생성자 로그인 성공 시 필요한 모든 정보를 설정
     *
     ...
     */
    public UserLoginResponseDto(String accessToken, String refreshToken, long expiresIn,
